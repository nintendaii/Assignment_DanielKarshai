...
namespace Module.Core.SO {
    ...
    public class SoAudioSfxContainer : SoContainerBase {
        ...
        public IAudioSfx GetValue(string key) => !string.IsNullOrEmpty(key) && valueByKey.ContainsKey(key) ? valueByKey[key].GetRandomData() : null;
        ...
        public override void Execute() {
            ...
            container = findAssets.Select(findAsset => AssetDatabase.LoadAssetAtPath<SoAudioSfx>(AssetDatabase.GUIDToAssetPath(findAsset))).ToArray();
            GenerateConstants();
#endif
        }
