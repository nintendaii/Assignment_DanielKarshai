...
namespace SmartUI.Scene {
    ...
    [AddComponentMenu("UI Enhanced/EnhancedGridLayoutGroup"), RequireComponent(typeof(RectTransform))]
    public class EnhancedGridLayoutGroup : LayoutGroup {
        ...
        public override void CalculateLayoutInputHorizontal() {
            ...
            cellSize.x = (rectTransform.rect.size.x - padding.horizontal - (fixColumnCount - 1) * spacing.x) / fixColumnCount;
