...
namespace Module.Core.Components {
    ...
    public class ImageCropper : Image {
        protected override void OnPopulateMesh(VertexHelper vh) {
            ...
            //Left
            GenerateMesh(vh, xMinMain - offsetMin.x, yMinMain - offsetMin.y, xMinMain, yMaxMain - offsetMax.y, color, 0);
            //Right
            GenerateMesh(vh, xMaxMain, yMinMain - offsetMin.y, xMaxMain - offsetMax.x, yMaxMain - offsetMax.y, color, 4);
            //Top
            ...
            if (polygonCollider2D != null) {
                ...
                //Left
                GenerateCollider(polygonCollider2D, xMinMain - offsetMin.x, yMinMain - offsetMin.y, xMinMain, yMaxMain - offsetMax.y, 0);
                //Right
                GenerateCollider(polygonCollider2D, xMaxMain, yMinMain - offsetMin.y, xMaxMain - offsetMax.x, yMaxMain - offsetMax.y, 1);
                //Top
        ...
        private static void GenerateMesh(VertexHelper vh, float xMin, float yMin, float xMax, float yMax, Color32 color32, int triangleIndex) {
        ...
        private static void GenerateCollider(PolygonCollider2D collider2d, float xMin, float yMin, float xMax, float yMax, int pathIndex) {
